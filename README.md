...
1. Скачайте `.dmg` файл из раздела [Releases](https://github.com/strigov/transcription-assistant/releases)
2. Откройте `.dmg` и перетащите приложение в папку Applications
3. При первом запуске macOS заблокирует приложение, так как оно не подписано сертификатом разработчика

**Чтобы разрешить запуск:**

- Откройте **Системные настройки** → **Конфиденциальность и безопасность**
- Прокрутите вниз — вы увидите сообщение о заблокированном приложении
- Нажмите **«Подтвердить вход»** (или **«Всё равно открыть»**)
...
Скачать установочным пакет и установить.
